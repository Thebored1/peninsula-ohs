...
export default function DeliverTalkForm({ sites, templates, workers, action }: Props) {
      ...
      <Grid>
        <Column sm={4} md={8} lg={12}>
          ...
          <Tile style={{ padding: '1.5rem', marginBottom: '1rem' }}>
            ...
            <div style={{ marginBottom: '1rem' }}>
              <TextInput
                ...
                placeholder="e.g. Main site shed, Level 2 meeting room"
              />
            </div>
            ...
            <TextArea
              ...
              placeholder="Any additional notes about the talk, key outcomes, follow-ups needed…"
              rows={3}
            />
          </Tile>
          ...
          <Tile style={{ padding: '1.5rem', marginBottom: '1rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.25rem' }}>
              <div>
                ...
                <p style={{ fontSize: '0.75rem', color: '#6f6f6f' }}>
                  Add all workers who attended this talk.
                </p>
              </div>
          ...
          <div style={{ display: 'flex', gap: '1rem' }}>
            ...
            <Button kind="secondary" href="/toolbox" disabled={loading}>
              Cancel
            </Button>
          </div>
        </Column>
